...
export default function TechnicalsPanel() {
  ...
  const [selectedTech, setSelectedTech] = useState<TechSignal | null>(null);
  ...
  return (
    <section className={styles.panel}>
      ...
      {selectedTech && (
        <TechChartModal signal={selectedTech} onClose={() => setSelectedTech(null)} />
      )}
    </section>
  );
}
