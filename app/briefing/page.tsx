...
> = {
  ko: {
    ...
    title: "오늘의 시장 브리핑",
    description:
      "핵심 자산의 움직임, 예정된 경제 이벤트, 그리고 AI 요약을 한곳에서 빠르게 확인할 수 있게 구성했습니다.",
    strongest: "가장 강한 자산",
    weakest: "가장 약한 자산",
    eventsToday: "오늘 일정",
    eventCountHint: "우선 체크할 이벤트 수",
    marketBrief: "브리핑 요약",
    ...
    askAi: "AI에게 브리핑 요청",
    assistant: "assistant",
    placeholder: "오늘 흐름을 어떻게 해석하면 좋을지 물어보세요.",
    loading: "브리핑 생성 중...",
    generate: "브리핑 생성",
    emptyAnswer: "아직 생성된 브리핑이 없습니다. 빠른 질문을 누르거나 직접 입력해 시작해보세요.",
  ...
  en: {
    ...
    description:
      "Review key asset moves, upcoming macro events, and an AI summary in one focused workspace.",
